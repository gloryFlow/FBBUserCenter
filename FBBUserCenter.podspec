#
#  Be sure to run `pod spec lint FBBUserCenter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                      私有Pods测试
                      FBBUserCenter用户模块工程 cocopods引用
                   DESC

  s.homepage     = "https://github.com/gloryFlow/FBBUserCenter"
  ...
  s.source       = { :git => "https://github.com/gloryFlow/FBBUserCenter.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "UserCenter/FBBUserCenter/FBBUserCenter/UserCenter/**/*.{h,m}"
